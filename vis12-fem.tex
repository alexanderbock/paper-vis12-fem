...
\begin{figure}[t]
    ...
    \subfigure[exit $\xi$]{\includegraphics[width=0.18\linewidth]{figures/breast_mesh/BreastExitXi1}}
    \subfigure[exit depth]{\includegraphics[width=0.18\linewidth]{figures/breast_mesh/BreastExitDepth1}}
    \subfigure[exit element IDs]{\includegraphics[width=0.18\linewidth]{figures/breast_mesh/BreastElementID2}}
...
\begin{figure}[b]
    \centering
    \subfigure[Equidistant sampling]{\includegraphics[width=0.32\linewidth, height=0.32\linewidth]{figures/arclength.pdf}\label{fig:arclength}}
    \hspace*{1cm}
...
helped to greatly improve this paper. We would also like to thank Assoc.-Prof. Alistair Young, who kindly provided the tagged MRI data of a healthy left ventricle. This work was partly supported by grants from the Swedish Research Council (VR, grant 2011-4113), the Excellence Center at Link\"oping and Lund in Information Technology (ELLIIT) and the Swedish e-Science Research Centre (SeRC). The presented concepts have been realized using the Voreen open source visualization framework (www.voreen.org).}
