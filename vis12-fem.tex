...
\begin{figure}[b]
  \centering 
  %%\subfigure[point coincidence]{\includegraphics[width=0.45\linewidth]{figures/point-coincidence}}
  %%\subfigure[surface coincidence]{\includegraphics[width=0.45\linewidth]{figures/surface-coincidence}}
...
\begin{figure}[b]
    ...
    \subfigure[volumetric rendering]{\includegraphics[width=0.45\linewidth]{figures/tongue2}}
