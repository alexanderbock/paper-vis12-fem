...
\begin{figure}[t]
    ...
    \caption{The error introduced by the approximation of the correct bent ray by sampling a spline. The abscissa shows the number of control points used to construct the spline, where 2 points represent a straight line. The error values were normalized w.r.t. this value and the ordinate is shown on a logarithmic scale.}
