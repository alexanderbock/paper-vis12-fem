...
\begin{figure}[t]
    \centering
    \subfigure[world space]{\includegraphics[width=0.35\linewidth, height=0.35\linewidth]{figures/splines_world_space.pdf}}
    \subfigure[$\xi$ space]{\includegraphics[width=0.35\linewidth, height=0.35\linewidth]{figures/splines_xi_space.pdf}}
    \subfigure[world $\mapsto \xi$]{\includegraphics[height=0.35\linewidth]{figures/viewingrays.pdf}}
...
\begin{figure}[b]
  \centering
      \centering 
      \subfigure{\includegraphics[width=0.30\linewidth, height=0.3\linewidth]{figures/coincidence/Coincidence.pdf}}
      \subfigure{\includegraphics[height=0.3\linewidth]{figures/coincidence/HeartFine_new.jpg}}
...
\begin{figure}[t]
    \centering
    \subfigure[entry world]{\includegraphics[width=0.18\linewidth]{figures/breast_mesh/BreastEntryWorld1}}
    \subfigure[entry $\xi$]{\includegraphics[width=0.18\linewidth]{figures/breast_mesh/BreastEntryXi1} \label{fig:depthpeeling:entryxi}}
    \subfigure[entry depth]{\includegraphics[width=0.18\linewidth]{figures/breast_mesh/BreastEntryDepth1}}
    \subfigure[entry element IDs]{\includegraphics[width=0.18\linewidth]{figures/breast_mesh/BreastElementID1} \label{fig:depthpeeling:entryid}}
    \subfigure[entry face IDs]{\includegraphics[width=0.18\linewidth]{figures/breast_mesh/BreastEntryFace1}}\\
    \subfigure[exit world]{\includegraphics[width=0.18\linewidth]{figures/breast_mesh/BreastExitWorld1}}
    \subfigure[exit $\xi$]{\includegraphics[width=0.18\linewidth]{figures/breast_mesh/BreastExitXi1} \label{fig:depthpeeling:exitxi}}
    \subfigure[exit depth]{\includegraphics[width=0.18\linewidth]{figures/breast_mesh/BreastExitDepth1}}
    \subfigure[exit element IDs]{\includegraphics[width=0.18\linewidth]{figures/breast_mesh/BreastElementID2} \label{fig:depthpeeling:exitid}}
    \subfigure[exit face IDs]{\includegraphics[width=0.18\linewidth]{figures/breast_mesh/BreastExitFace1}}
...
\begin{figure}[t]
    \centering
    \subfigure[Precomputed proxy rays with $s_f$ = 2]{\includegraphics[width=0.39\linewidth]{figures/heart-2-new-with-closeup.pdf}
    \includegraphics[width=0.39\linewidth]{figures/heart-2-rr-ii-new-with-closeup.pdf}}\\
    \subfigure[Precomputed proxy rays with $s_f$ = 10]{\includegraphics[width=0.39\linewidth]{figures/heart-10-new-with-closeup.pdf}
...
\begin{figure}[b]
    \centering
    \subfigure[Equidistant sampling]{\includegraphics[width=0.5\linewidth, height=0.32\linewidth]{figures/arclength.pdf}\label{fig:arclength}}
    \subfigure[Boundary handling]{\includegraphics[width=0.32\linewidth, height=0.32\linewidth]{figures/overshoot.pdf} \label{fig:overshoot}}
...
\begin{figure}
    \centering 
    \subfigure[surface rendering]{\includegraphics[width=0.42\linewidth]{figures/fem-breast}}
    \subfigure[volumetric rendering]{\includegraphics[width=0.42\linewidth]{figures/Breast}}
...
\begin{figure}
    \centering 
    \subfigure[polygonal rendering]{\includegraphics[width=0.42\linewidth]{figures/fem-tongue}}
    \subfigure[opaque volumetric rendering]{\includegraphics[width=0.42\linewidth]{figures/tongue3}}\\
    \subfigure[translucent volumetric rendering]{\includegraphics[width=0.84\linewidth]{figures/fem-tongue-new-sidebyside}}
...
\begin{figure*}[t]
    \centering
    \subfigure[Error introduced by approximating the bent ray by a spline]{\includegraphics[width=0.325\linewidth]{measurements/spline_approximation/spline_approximation.pdf} \label{fig:spline_control_points_error}}
    \subfigure[Error introduced by clustering]{\includegraphics[width=0.325\linewidth]{measurements/clustering/clustering_error.pdf} \label{fig:clustering_epsilon_error}}
    \subfigure[Image error measured for varying cluster sizes]{\includegraphics[width=0.325\linewidth]{measurements/cluster_measurements/clusterErrorPlot.pdf} \label{fig:clustering_visual_error}}
