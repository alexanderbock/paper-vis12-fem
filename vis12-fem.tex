...
\begin{figure}[t]
    ...
    \caption{The normalized absolute pixel error (background pixels are neglected) plotted against the percentage of clusters relative to the total amount of curves. The calculations have been performed on the subfigures of the teaser image, thus varying the transfer function and strain direction.}
